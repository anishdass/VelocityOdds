...
* The original package name 'com.velocity.sports.odds-engine' is invalid and this project uses 'com.velocity.sports.odds_engine' instead.
...
* [Prometheus](https://docs.spring.io/spring-boot/4.0.4/reference/actuator/metrics.html#actuator.metrics.export.prometheus)
